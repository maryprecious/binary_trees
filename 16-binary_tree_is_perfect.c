...
/**
 * binary_tree_is_perfect - will check for perfect binary tree
...
/**
 * recurse_for_balance - the  utility for checking tree and subtrees
...
int recurse_for_balance(const binary_tree_t *tree)
{
	...
	/* take the balance factor of every tree/subtree */
...
int binary_tree_balance(const binary_tree_t *tree)
{
	...
	/* rightfully calculate height of left and right subtrees */
...
/**
 * recurse_for_height - measures the height
